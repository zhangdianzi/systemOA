...
<div class="pageContent">
    <form method="post" action="system/orderInfo/issue.html" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        ...
        <h2 class="contentTitle">基本资料：</h2>
          ...
          <label>审核备注：</label>
          <textarea name="controlman_note" readonly cols="55" rows="3" style="color:#0000ff">${controlman_note}</textarea>
          <label>签发备注：</label>
          <textarea name="manager_note" cols="55" rows="3" style="color:#ff0000"></textarea>
         </p>
         <p>
          <label>是否通过：</label>
