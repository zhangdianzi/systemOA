...
<header class="am-topbar admin-header">
  <div class="am-topbar-brand">
    <strong>Mr.Zhang</strong> <small>后台管理系统</small>
  </div>
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li class="am-dropdown" data-am-dropdown>
        <a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
          <span class="am-icon-users"></span> ${funcs:getSessionLoginUser(pageContext.session).realName} <span class="am-icon-caret-down"></span>
        </a>
        <ul class="am-dropdown-content">
          <li><a href="javascript:showWindows()" data-featherlight="#fl3"><span class="am-icon-user"></span> 资料</a></li>
          <li><a href="#"><span class="am-icon-cog"></span> 设置</a></li>
          <li><a href="system/account/toSalary.html .ajaxcontent" data-featherlight="ajax">Content</a></li>
          <li><a href="system/account/loginLog.html" data-featherlight="ajax">Ajax</a> </li>
          <li><a href="logout.html"><span class="am-icon-power-off"></span> 退出</a></li>
        </ul>
<!--         <a class="btn btn-default" href="javascript:" data-featherlight="#fl3">iFrame</a>  -->
      </li>
      ...
      <ul class="am-list admin-sidebar-list">
        <li><a href="index.html"><span class="am-icon-home"></span> 首页</a></li>
         ...
         <c:forEach var="menu" items="${requestScope.menus}" varStatus="rowstat">
          ...
          <a class="am-cf" data-am-collapse="{target: '#${menu.id}'}"><span class="am-icon-file"></span> ${menu.name} <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="${menu.id}">
          
          <c:forEach var="menuchild" items="${requestScope.menus}" varStatus="c">
          <c:if test="${menuchild.parentId==menu.id}">
            <li><a href="javascript:changeNavTab('${menuchild.url}');" ><span class="am-icon-th"></span> ${menuchild.name}</a></li>
            </c:if>
            </c:forEach>
          </ul>
        </li>
...
<!--         <li><a href="#"><span class="am-icon-sign-out"></span> 注销</a></li> -->
      ...
      <div class="am-panel am-panel-default admin-sidebar-panel">
        <div class="am-panel-bd">
          ...
          <p>时光静好，与君语；细水流年，与君sdddddddddddd同。—— Amaze UI</p>
          <p>时光静好，与君语；细水流年，与君dffffffffff同。—— Amaze UI</p>
        </div>
      </div>
  ...
  <!-- content start -->
  <div class="admin-content" id="navTab">
