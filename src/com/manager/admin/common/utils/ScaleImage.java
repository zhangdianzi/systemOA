...
public class ScaleImage
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			is.generateThumbnail("d:/ftptest/dfasdf.jpg", "d:/ftptest/dfasdf_thum.jpg", 160, 200);
			System.out.println(" scale image success ");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	 ...
	 * 生成缩略�?
	 * 
	 * @param fromFileStr 原图片地�?
	 * @param saveToFileStr 生成缩略图地�?
	 * @param formatWideth 生成图片宽度
	 * @param formatHeight formatHeight高度
	 */
	public void generateThumbnail(String fromFileStr, String saveToFileStr, int formatWideth, int formatHeight)
			throws Exception
	{
		File saveFile = new File(saveToFileStr);
		File fromFile = new File(fromFileStr);
		generateThumbnail(fromFile, saveFile, formatWideth, formatHeight);
	}
	 ...
	 * 
	 * @param fromFile 原图�?
	 * @param saveToFile 生成缩略�?
	 * @param formatWideth 生成图片宽度
	 * @param formatHeight formatHeight高度
	 */
	public void generateThumbnail(File fromFile, File saveFile, int formatWideth, int formatHeight) throws Exception
	{
		BufferedImage srcImage = javax.imageio.ImageIO.read(fromFile); // construct image
